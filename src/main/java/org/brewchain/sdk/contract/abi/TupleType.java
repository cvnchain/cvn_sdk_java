...
import static org.brewchain.sdk.contract.abi.Encoding.OFFSET_LENGTH_BYTES;
...
//                }
    ...
    public static String format(byte[] abi) {
        ...
        while(idx < abi.length) {
            sb.append(Strings.encode(Arrays.copyOfRange(abi, idx, idx + UnitType.UNIT_LENGTH_BYTES), HEX)).append('\n');
