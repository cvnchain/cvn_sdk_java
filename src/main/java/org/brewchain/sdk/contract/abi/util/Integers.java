...
*/
package org.brewchain.sdk.contract.abi.util;
...
public final class Integers {
    ...
    public static long packUnsigned(long unsigned, UintType uintType) {
        ...
        final int bitLen = org.brewchain.sdk.contract.rlp.util.Integers.bitLen(unsigned);
    ...
    public static long unpackUnsigned(long signed, UintType uintType) {
        ...
        final int bitLen = signed < 0 ? BizarroIntegers.bitLen(signed) : org.brewchain.sdk.contract.rlp.util.Integers.bitLen(signed);
        if(bitLen >= uintType.numBits) {
